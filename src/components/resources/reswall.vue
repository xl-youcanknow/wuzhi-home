<template>
  <div class="view-res-detail">
    <div class="head-img">
      <img v-if="width>768" src="@/public/img/resdetail/wall_big.png" alt>
      <img v-else src="@/public/img/resdetail/wall-mobile.png" alt>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      list:null,
      urlPath:null,
      imgs:require('../../public/img/resdetail/1.png')
    };
  },
  created() {
    getChildType({type_id:0}).then(res=>{
