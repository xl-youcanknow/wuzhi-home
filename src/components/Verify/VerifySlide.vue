<template>
    <div style="position: relative;" v-show="iswoker"
        ...
        <div class="verify-bar-area" :style="{width: setSize.barWidth,
            ...
            <div class="verify-left-bar"
                 :style="{width: (leftBarWidth!==undefined)?leftBarWidth: barSize.height, height: barSize.height, 'border-color': leftBarBorderColor, transaction: transitionWidth,background:background}">
                <span class="verify-msg"></span>
                <div class="verify-move-block"
                     @touchstart="start"
                     @mousedown="start"
                     :style="{width: barSize.height, height: barSize.height, 'background-color': moveBlockBackgroundColor, left: moveBlockLeft, transition: transitionLeft,border:border}">
                    <i :class="['verify-icon ', iconClass]"
...
<script type="text/babel">
    ...
    export default {
        ...
        methods: {
            boxShod(){
              this.boxshadow="1px 1px 11px #0089E5";
            },
            unboxShod(){
              this.boxshadow="";
            },
            ...
            start: function (e) {
                if (this.isEnd == false) {
                    this.text = ''
                    this.moveBlockBackgroundColor = '#0089E5'
                 //   this.leftBarBorderColor = '#0089E5'
                    this.iconColor = '#fff'
                    this.background="rgba(0,137,229,.65)"
                    e.stopPropagation();
                    e.preventDefault();
                    this.status = true;
                }
...
//                    }
                    ...
                    this.leftBarWidth = (move_block_left - parseInt(parseInt(this.blockSize.width) / 2)+40) + "px"
...
//                            this.htmlDoms.left_bar.css({'border-color': '#5cb85c', 'background-color': '#fff'});
                        ...
                        if (parseInt((this.moveBlockLeft || '').replace('px', '')) >= (parseInt(this.setSize.barWidth) - parseInt(this.barSize.height) - parseInt(this.vOffset))) {
                          ...
                          //  this.leftBarBorderColor = '#5cb85c'
                            ...
                            this.background="rgba(92,184,92,.65)"
                            this.border="1px solid #5cb85c"
                            this.showRefresh = false
                          ...
                          /*  const thar=this;
                            ...
                            this.leftBarBorderColor = '#d9534f'
                            this.iconColor = '#fff'
                            this.background="rgba(217,83,79,.65)"
                            this.border="1px solid #d9534f"
